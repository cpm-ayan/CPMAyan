...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{01}: Increase Money           1.500'))      print(Colorate.Horizontal(Colors.rainbow, '{02}: Increase Coins           4.500'))print(Colorate.Horizontal(Colors.rainbow, '{03}: King Rank                8.000'))print(Colorate.Horizontal(Colors.rainbow, '{04}: Change ID                4.500'))print(Colorate.Horizontal(Colors.rainbow, '{05}: Change Name              100'))print(Colorate.Horizontal(Colors.rainbow, '{06}: Change Name (Rainbow)    100'))print(Colorate.Horizontal(Colors.rainbow, '{07}: Number Plates            2.000'))print(Colorate.Horizontal(Colors.rainbow, '{08}: Account Delete           FREE'))print(Colorate.Horizontal(Colors.rainbow, '{09}: Account Register         FREE'))
            '))
