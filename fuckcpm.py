...
__CHANNEL_USERNAME__ = "FUCKCPM"
__GROUP_USERNAME__   = "FUCKCPM"
...
def banner(console):
    ...
    brand_name = figlet_format('DICK', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ CPM DEV FUCKED LOLL[/bold green]: скрипт который поможет вам стать самым крутым.")
