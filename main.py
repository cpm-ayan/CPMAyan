...
def banner(console):
    ...
    brand_name = figlet_format('ZtzAyan', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ CarParkingTool[/bold green]: Mery Bhai Ye Car Parking Multiplayer ka Tool ha shukriya isko lene k liye.")
    ...
    console.print("[bold yellow]! Note[/bold yellow]: Mery Bhai Is tool ko use krny sy pehly game sy account logout krdo shukriya!.", end="\n\n")
    ...
    while True:
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if amount > 0 and amount <= 500000000000000000000000000000000000:
                ...
                amount = IntPrompt.ask("[bold][?] Amount[/bold]")
                console.print("[bold cyan][%] Saving your data[/bold cyan]: ", end=None)
                if amount > 0 and amount <= 2000000000000000000000000000000000000:
                ...
                console.print("[bold cyan][%] Saving your data[/bold cyan]: ", end=None)
                if len(new_id) >= 2 and len(new_id) <= 50000 and (' ' in new_id) == False:
                ...
                if amount > 0 and amount <= 1000000000000000000000000000000000000000000000000:
